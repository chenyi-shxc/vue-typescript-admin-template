<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['datavisual:zkrProjectRepay:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['datavisual:zkrProjectRepay:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['datavisual:zkrProjectRepay:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['datavisual:zkrProjectRepay:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="zkrProjectRepayList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="本息通知单单号" align="center" prop="invoiceTranNo" />
      <el-table-column label="本息通知单类型" align="center" prop="invoiceType" />
      <el-table-column label="本息通知单类型名称" align="center" prop="invoiceTypeName" />
...
<script>
import { listZkrProjectRepay, getZkrProjectRepay, delZkrProjectRepay, addZkrProjectRepay, updateZkrProjectRepay, exportZkrProjectRepay } from "@/api/datavisual/zkrProjectRepay";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除项目本息回收信息编号为"' + bookBranchs + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有项目本息回收信息数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
