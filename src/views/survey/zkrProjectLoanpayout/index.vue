    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['survey:zkrProjectLoanpayout:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['survey:zkrProjectLoanpayout:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['survey:zkrProjectLoanpayout:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['survey:zkrProjectLoanpayout:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listZkrProjectLoanpayout, getZkrProjectLoanpayout, delZkrProjectLoanpayout, addZkrProjectLoanpayout, updateZkrProjectLoanpayout, exportZkrProjectLoanpayout } from "@/api/survey/zkrProjectLoanpayout";
