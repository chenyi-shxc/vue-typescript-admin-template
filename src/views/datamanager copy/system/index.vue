  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="系统描述" prop="systemDesc">
        <el-input
          v-model="queryParams.systemDesc"
          placeholder="请输入系统描述"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="系统状态" prop="systemStatus">
        <el-select v-model="queryParams.systemStatus" placeholder="请选择系统状态" clearable size="small">
          <el-option label="请选择字典生成" value="" />
        </el-select>
      </el-form-item>
      <el-form-item label="系统类型" prop="systemType">
        <el-select v-model="queryParams.systemType" placeholder="请选择系统类型" clearable size="small">
          <el-option label="请选择字典生成" value="" />
        </el-select>
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['datamanager:system:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['datamanager:system:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['datamanager:system:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['datamanager:system:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="systemList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="系统描述" align="center" prop="systemDesc" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="系统描述" prop="systemDesc">
          <el-input v-model="form.systemDesc" placeholder="请输入系统描述" />
        </el-form-item>
...
<script>
import { listSystem, getSystem, delSystem, addSystem, updateSystem, exportSystem } from "@/api/datamanager/system";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除数据管理-应用系统编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有数据管理-应用系统数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
